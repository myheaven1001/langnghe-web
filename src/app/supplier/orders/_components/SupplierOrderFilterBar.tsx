...
// Same GET-form pattern as buyer /orders' OrderFilterBar, posting to
// /supplier/orders instead.
export function SupplierOrderFilterBar({
  status,
  q,
  range,
  sort,
    ...
    >
      ...
      <div className="relative min-w-[200px] max-w-[320px] flex-1">
        ...
        <input
          ...
          name="q"
          defaultValue={q}
          placeholder="Tìm theo tên buyer, mã vận đơn..."
